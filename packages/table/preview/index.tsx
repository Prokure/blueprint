...
class FormatsTable extends React.Component<{}, {}> {
    ...
    private renderDefaultCell = (row: number) => <Cell className="nigger" onClick={()=>console.log("clicked")} onMouseEnter={()=>console.log("hovered")} onMouseLeave={()=>console.log("left")}>{this.strings[row]}</Cell>;
